...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/table.json":[function(require,module,exports) {
module.exports = {
  "fields": [{
    "id": "id",
    "label": "User ID"
...
},{"./helper":"scripts/helper.js"}],"scripts/script.js":[function(require,module,exports) {
"use strict";
...
const users = _UsersService.default.getUsers();

createTable(users, _table.fields);
...
function createTable(data, fields) {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    for (let j = 0; j < fields.length; j++) {
      ...
      if (paramId === 'name') {
        const str = `<a href="/new_user.html?id=${data[i].id}">${value}</a>`;
        td.innerHTML = str;
      } else {
        if (value !== undefined) {
          td.innerText = value;
...
},{"./table.json":"scripts/table.json","./UsersService":"scripts/UsersService.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
